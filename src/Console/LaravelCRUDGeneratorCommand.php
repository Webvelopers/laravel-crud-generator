...
class LaravelCRUDGeneratorCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $model = $this->model();
        $this->components->info("Model [$model] created successfully.");
